...
>>>>>>> e8abb88eff26b6d68af3efbbe29032b6af43e261
...
vectorTransPlot <- ggplot(data = plotdf) +
  geom_point(data = plotdf[plotdf$genotype == "WT",], aes(y = p_infect, x = xf_vector_log10), size = 4, pch = 1) +
  geom_point(data = plotdf[plotdf$genotype == "DSF",], aes(y = p_infect, x = xf_vector_log10), size = 4, pch = 2) +
...
sourceTransPlot <- ggplot(data = plotdf) +
  geom_point(data = plotdf[plotdf$genotype == "WT",], aes(y = p_infect, x = xf_source_log10), size = 4, pch = 1) +
  geom_point(data = plotdf[plotdf$genotype == "DSF",], aes(y = p_infect, x = xf_source_log10), size = 4, pch = 2) +
...
plot(-10, -10,
     ...
     ylim = range(data$xf_source_plant, na.rm = TRUE),
     xlab = 'Distance', ylab = 'Predicted Source Plant xf Concentration')
points(constants$distance[dsf_ind], y = data$xf_source_plant[dsf_ind], col = 'blue', pch = 4)
points(constants$distance[wt_ind],  y = data$xf_source_plant[wt_ind],  col = 'red',  pch = 4)
lines(pred_df_dsf$distance, pred_df_dsf$xf_plant_med, col = 'blue')
lines(pred_df_wt$distance,  pred_df_wt$xf_plant_med,  col = 'red')
legend(legend = c('DSF', 'WT'), 'topright', col = c('blue', 'red'), lty = 1)
